...
private:
	...
	*/
	...
	// Ritorna true se nel vettore idEdgesToCut c'è ancora almeno un true
...
public:
	...
	// Funzione che ricalcola tutte le informazioni di vicinanza dei punti
	void AggiornaInformazioniPunti();
